...
## :three: Работа с подами и контейнерами
...
## :four: Настройка и подключение к сервису через UI
```bash
...
## :five: Собираем свой контейнер используя UBI 7.7 в качестве базового образа
